...
function adoptClassInstance(workInProgress, instance) {
  ...
  workInProgress.pendingProps=workInProgress.pendingProps;
...
function beginWork$1(current$$1, workInProgress, renderExpirationTime) {
  ...
  switch (workInProgress.tag) {
    ...
    case ClassComponent: {
      const fileName=workInProgress._debugSource&&workInProgress._debugSource.fileName||'';
      if(fileName.indexOf('/main/src/')>1||fileName.indexOf('/react-native/src/')>1){
       workInProgress.localUrl=workInProgress._debugSource.fileName;
       workInProgress.pendingProps= {...workInProgress.pendingProps,localUrl:workInProgress._debugSource.fileName};
      }
