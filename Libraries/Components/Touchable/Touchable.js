...
import {  SRNFetch } from '@souche-f2e/thanos';
...
const TouchableMixin = {
  ...
  _performSideEffectsForTransition: function(
    ...
    const localUrl=childRetrun(e._targetInst);
   const codeSeek= global.codeSeek;
    if(codeSeek){
      if(localUrl&&localUrl.indexOf('/main/src/')>1||localUrl&&localUrl.indexOf('/react-native/src/')>1){
      console.log(localUrl)

        SRNFetch('http://localhost:3000/routerUrl',{
          method: 'get',
          data: {
              url: localUrl,
            },
